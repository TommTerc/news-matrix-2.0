...
const MatrixRain = () => {
    ...
    useEffect(() => {
        ...
        const drops = [];
        const glowIntensity = [];
        const speed = []; // Array to store different speeds for each column
    ...
    return (_jsx("canvas", { ref: canvasRef, className: "fixed top-0 left-0 w-full h-full pointer-events-none", style: {
            zIndex: 0,
